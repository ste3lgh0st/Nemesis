...
module.exports = {
    ...
    async run(bot, message) {
        const modal = new Discord.ModalBuilder()
            .setCustomId("modal_sanction")
            .setTitle("Émettre une sanction disciplinaire");

        const inputMembre = new Discord.TextInputBuilder()
            .setCustomId("input_membre")
            .setLabel("Membre sanctionné")
        ...
        const inputDuree = new Discord.TextInputBuilder()
            ...
            .setLabel("Durée de la sanction")
            .setPlaceholder("Ex: 48h, 1 semaine, Définitive")
            .setStyle(Discord.TextInputStyle.Short)
            .setRequired(true);

        const inputMotif = new Discord.TextInputBuilder()
            .setCustomId("input_motif")
            .setLabel("Motif de la sanction")
            .setPlaceholder("Indiquez le motif exact...")
